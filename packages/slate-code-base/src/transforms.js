...
import { CODE_TYPE, CODE_LINE_TYPE, DEFAULT_OPTION } from './constants';
...
export default {
  ...
  exitCodeBlock(editor) {
    ...
    return Editor.select(editor, newPath);
  },
